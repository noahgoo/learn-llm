 ...
 * beat captions (StageCaptions); full cited explanations live in the
 * explanation drawer. Fades between stages so it reads as a quiet
 * "where am I" marker, not a wall.
 */
